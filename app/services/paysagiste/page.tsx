...
export default function PaysagistePage() {
  return (
    <main className="bg-gradient-to-br from-[#f8fafc] to-[#e0e7ef] dark:from-gray-900 dark:to-gray-950 min-h-screen">
      {/* HERO */}
      <section className="relative flex flex-col-reverse md:flex-row items-center justify-between gap-8 px-6 py-20 md:py-32 max-w-7xl mx-auto">
        ...
        <div className="flex-1 flex justify-center items-center relative min-h-[320px]">
          <Image
            src="/images/banners/paysagiste-hero.jpg"
            ...
            priority
          />
          {/* Ajoutez une image adaptée dans public/images/banners/paysagiste-hero.jpg */}
        </div>
      </section>

      {/* SERVICES */}
      <section className="py-20 px-4 max-w-6xl mx-auto">
        <SectionTitle>Nos services paysagistes</SectionTitle>

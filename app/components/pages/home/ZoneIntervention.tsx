...
export default function ZoneIntervention() {
  ...
  const bgGradient = "bg-gradient-to-r from-gray-900 to-gray-700";
      ...
      <div className="flex flex-wrap justify-center gap-4 max-w-[1700px] mx-auto">
        {links.map((link, i) => (
          ...
          >
            <Link
              href={link.href}
              className="inline-block px-4 py-2 bg-[#f3b926] text-white rounded hover:bg-primary-dark transition hover:scale-90 duration-300"
            >
              {link.label}
            </Link>
          </motion.section>
